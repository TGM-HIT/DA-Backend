...
public class GlobalExceptionHandler {
    ...
    private static List<String> getRequiredRoles(AuthorizationDeniedException e) {
        if (e.getAuthorizationResult() instanceof ExpressionAuthorizationDecision) {
            ExpressionAuthorizationDecision result = (ExpressionAuthorizationDecision) e.getAuthorizationResult();
            if (result.getExpression() instanceof SpelExpression) {
                SpelExpression expression = (SpelExpression) result.getExpression();
                if (expression.getAST() instanceof MethodReference) {
                    MethodReference ast = (MethodReference) expression.getAST();
