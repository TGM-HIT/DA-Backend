...
public class LogController {
    ...
    public ResponseEntity<String> getLog(@PathVariable String name, @RequestParam String secret) {
        ...
        if (file.exists()) {
            ...
            sb.append("<html><head><style>pre{white-space: pre-wrap; white-space: -moz-pre-wrap; white-space: -pre-wrap;  white-space: -o-pre-wrap; word-wrap: break-word;}</style></head><body><pre>");
