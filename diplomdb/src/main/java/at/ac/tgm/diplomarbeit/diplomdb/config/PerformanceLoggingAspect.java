 ...
 * Dieser Aspekt fängt Aufrufe aller Methoden im Package at.ac.tgm.diplomarbeit.diplomdb.service
...
public class PerformanceLoggingAspect {
     ...
     */
    private static final Logger PERF_LOGGER = LoggerFactory.getLogger("at.ac.tgm.diplomarbeit.diplomdb.performance");
     ...
     */
    @Around("execution(* at.ac.tgm.diplomarbeit.diplomdb.service..*(..))")
